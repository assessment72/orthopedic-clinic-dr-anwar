...
function EditAdmissionForm({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!translationsLoaded) {
    return (
      <ProtectedRoute>
        <SidebarLayout title={t('inpatient.editAdmission')} description="" dense>
    ...
    return (
      <ProtectedRoute>
        <SidebarLayout title={t('inpatient.editAdmission')} description="" dense>
          <div className="flex items-center justify-center h-48">
            <div className="animate-spin rounded-full h-7 w-7 border-b-2 border-blue-600"></div>
            <span className="ml-3 text-sm text-gray-600">Loading admission data...</span>
          </div>
        </SidebarLayout>
      </ProtectedRoute>
    );
  ...
  return (
    <ProtectedRoute>
      <SidebarLayout
        ...
        description={t('inpatient.editAdmissionDescription')} dense>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <>
                    <div>
                      ...
                      <input
                        ...
                        disabled
                        className="w-full h-9 px-3 text-sm border border-gray-300 rounded-md bg-gray-50"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-medium text-gray-700 mb-0.5">
              ...
              <div className="mb-2">
                ...
                <div className="flex gap-2 mb-2">
                  ...
                  <button
                    type="button"
                    onClick={addAllergy}
                    className="h-9 px-3 text-sm bg-gray-100 rounded-md hover:bg-gray-200 shrink-0"
                  >
                    {t('common.add')}
                  </button>
                </div>
            ...
            <div className="flex items-center gap-2">
              <button
                type="submit"
                disabled={saving}
                className="inline-flex items-center gap-1.5 h-9 px-4 text-sm font-medium bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:opacity-50"
              >
