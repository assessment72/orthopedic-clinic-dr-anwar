...
function EditWardForm({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!translationsLoaded) {
    return (
      <ProtectedRoute>
        <SidebarLayout title={t('inpatient.editWard')} description="" dense>
    ...
    return (
      <ProtectedRoute>
        <SidebarLayout title={t('inpatient.editWard')} description="" dense>
          <div className="flex items-center justify-center h-48">
            <div className="animate-spin rounded-full h-7 w-7 border-b-2 border-blue-600"></div>
            <span className="ml-3 text-sm text-gray-600">Loading ward data...</span>
          </div>
        </SidebarLayout>
      </ProtectedRoute>
    );
  ...
  return (
    <ProtectedRoute>
      <SidebarLayout
        ...
        description={t('inpatient.editWardDescription')} dense>
